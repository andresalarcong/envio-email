...
public class EnvioDeCorreoElectronicoDefinitions {
	...
	public void dadoQueHeIngresadoAGmail() {
		logger.info("EnvioDeCorreoElectronicoDefinitions.dadoQueHeIngresadoAGmail()");
	...
	public void cuandoEnvieCorreo(List<EmailModel> correo) {
		logger.info("EnvioDeCorreoElectronicoDefinitions.cuandoEnvieCorreo()");
		this.correo = correo;
	...
	public void entoncesValidarQueElDestinatarioRecibeElMensaje(List<EmailModel> correo) {
		logger.info("EnvioDeCorreoElectronicoDefinitions.entoncesValidarQueElDestinatarioRecibeElMensaje()");
	...
	public void entoncesDebeAparecerUnaVentanaDeErrorIndicandoDestinoIncorrecto() {
		logger.info("EnvioDeCorreoElectronicoDefinitions.entoncesDebeAparecerUnaVentanaDeErrorIndicandoDestinoIncorrecto()");
